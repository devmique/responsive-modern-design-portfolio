    ...
    <main>
      ...
      <Section id="projects">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[{img:p1,title:"Parents Portal Management System", desc: "Tech stack: React.js, Node.js, Express.js, MySQL"},{img:p2,title:"Ticket Marketplace", desc: "Tech stack: Next.js, Shadcn UI, Convex, Stripe"},{title:"404", desc: "Not Found."}].map((p, i) => (
