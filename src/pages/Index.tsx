    ...
    <main>
      ...
      <Section id="projects">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {img:p4,title:"WorkspaceOS — A SaaS Workspace Dashboard", desc: "A SaaS application that showcases production-ready patterns including Row Level Security, Server Actions, optimistic UI updates, and multi-tenancy with activity tracking.", glink:"https://github.com/devmique/saas-workspace-dashboard/", llink:"https://saas-workspace-dashboard.vercel.app/", tech: ["Next.js", "TailwindCSS", "Supabase", "Shadcn-UI", "Recharts"]}, 
          {img:p5,title:"TranSync PH — B2B SaaS Bus Operator Management System ", desc: "A B2B SaaS platform for Philippine bus operators to manage routes, schedules, and terminals — with a public-facing commuter live map for terminal locations, routes and schedule information.", glink:"https://github.com/devmique/b2b-saas-bus-operator-management-system", llink:"https://transyncph.vercel.app/", tech:["Next.js", "Tailwind CSS", "Shadcn-UI", "MongoDB", "Leaflet", "Zod"]}].map((p, i) => (
